...
class SettingsFragment : Fragment() {
    ...
    private fun showLocationPermissionDialog() {
        ...
        builder.setMessage("'Şantiye Takip' uygulamasında şantiye konumunu görüntülemek ve şantiye konumuna gidebilmek için konum izni gereklidir.Siz eklemediğiniz sürece konum bilgisi eklenmez.Ayrıca şantiye konumu haricinde hiç bir konum bilgisi kaydedilmez veya gösterilmez.")
