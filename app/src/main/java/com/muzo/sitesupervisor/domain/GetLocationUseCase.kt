...
class GetLocationUseCase @Inject constructor(private val repository: FireBaseRepository) {

    suspend operator fun invoke(currentUser: String, constructionName: String):Flow<Pair<String, String>>{
        return flow {
            val result=repository.uploadLocation(currentUser, constructionName)
